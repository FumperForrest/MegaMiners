...
rubyParticleSystem = love.graphics.newParticleSystem(spriteSheet, 100)
rubyParticleSystem:setQuads(rubyParticle)

rubyParticleSystem:setParticleLifetime(1, 3)
rubyParticleSystem:setSizeVariation(0.5)
rubyParticleSystem:setSpeed(30,50)
rubyParticleSystem:setDirection(math.pi / 2)
rubyParticleSystem:setLinearAcceleration(0,70,0,90)
rubyParticleSystem:setSpread(1)
rubyParticleSystem:setSpin(5,7)
rubyParticleSystem:setRotation(math.random(0,360))